...
contract NFTMarketplace is ERC721URIStorage{
    ...
    modifier onlyOwner{
        ...
        _; //this means the if this is true then next function will continue...
    }
    ...
    function createMarketSale(uint256 tokenId) public payable{
        ...
        idMarketPrice[tokenId].owner = payable(msg.sender);
        idMarketPrice[tokenId].sold = true;
        idMarketPrice[tokenId].owner = payable(address(0));
        ...
        payable(idMarketItem[tokenId].seller).trasfer(msg.value);
